const Termo = ()=> {
    ...
    return <div class="container">
            <img src="../../img/jpw.png" class="imgTermo"/>
...
<p> </p>
<p>Este documento, e todo o conteúdo do site é oferecido por <strong>JPW Ferragens</strong>, neste termo representado apenas por "EMPRESA", que regulamenta todos os direitos e obrigações com todos que acessam o site, denominado neste termo como "VISITANTE", reguardado todos os direitos previstos na legislação, trazem as cláusulas abaixo como requisito para acesso e visita do mesmo, situado no endereço <strong>.</strong></p>
<p> </p>
...
<p> </p>
<p>Este Termo de uso é valido a partir de 06 de Julho de 2022.</p>
<p> </p>
    </div>
}
